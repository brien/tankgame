...
void TankRenderer::RenderTanks(const std::vector<TankRenderData>& tanks) {
    // Legacy wrapper for backward compatibility
    RenderMultiple(tanks);
}

void TankRenderer::RenderTank(const TankRenderData& tank) {
    // Legacy wrapper for backward compatibility
    Render(tank);
}
...
void TankRenderer::RenderTankBody(const TankRenderData& tank) {
...
void TankRenderer::RenderTankTurret(const TankRenderData& tank) {
...
void TankRenderer::RenderTankEffects(const TankRenderData& tank) {
...
void TankRenderer::RenderTankHUD(const TankRenderData& tank) {
...
void TankRenderer::SetTankColor(const TankRenderData& tank, bool isPrimary) {
    if (isPrimary) {
...
void TankRenderer::ApplyHealthColor(float& r, float& g, float& b, float health, float maxHealth) {
...
void TankRenderer::RenderBasicTank(const TankRenderData& tank) {
...
void TankRenderer::RenderPlayerEffects(const TankRenderData& tank) {
...
void TankRenderer::RenderPlayerTargetingUI(const TankRenderData& tank) {
