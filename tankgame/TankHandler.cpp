...
void TankHandler::DrawTanks()
{
    ...
    /*
     ...
     glColor3f(player.r*(player.energy/player.maxEnergy), player.g*(player.energy/player.maxEnergy), player.b*(player.energy/player.maxEnergy));
     glCallList(App::GetSingleton().graphicsTask->bodylistEx);
